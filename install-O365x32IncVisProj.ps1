...
install-O365x32 -AcceptEULA TRUE -Channel MonthlyEnterprise -OfficeArch 32 -IncludeProject -IncludeVisio -LanguageIDs en-US,nl-NL,fr-FR,de-De,it-IT,pt-PT,es-ES -ExcludeApps groove,lync,onedrive,onenote,publisher,teams -PinItemsToTaskbar FALSE -CleanUpInstallFiles -SharedComputerLicensing 1