...
.PROJECTURI https://github.com/mallockey/Install-Office365Suite
...
Param(
  ...
  [String]$OfficeInstallDownloadPath = "$env:Programdata\POSD\O365",
...
install-O365x32 -AcceptEULA TRUE -Channel MonthlyEnterprise -OfficeArch 32 -IncludeProject -IncludeVisio -LanguageIDs en-US,nl-NL,fr-FR,de-De,it-IT,pt-PT,es-ES,pl-pl -ExcludeApps groove,lync,onedrive,onenote,publisher,teams -PinItemsToTaskbar FALSE -CleanUpInstallFiles -SharedComputerLicensing 1