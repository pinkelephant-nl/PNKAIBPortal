...
install-O365x64 -AcceptEULA TRUE -Channel MonthlyEnterprise -OfficeArch 64 -LanguageIDs en-US,nl-NL,fr-FR,de-De,it-IT,pt-PT,es-ES -ExcludeApps groove,lync,onedrive,onenote,publisher,teams -PinItemsToTaskbar FALSE -CleanUpInstallFiles -SharedComputerLicensing 1